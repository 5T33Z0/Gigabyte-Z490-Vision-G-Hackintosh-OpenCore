...
- In macOS Venturea the `AppleIntelI210Ethernet.kext` was removed. Luckily the dext version is still present under /System/Library/DriverExtensions/com.apple.DriverKit-AppleEthernetE1000.dext, so you need to make sure the I225-V connects to it. Therefor you need to disable boot-args `dk.e1000=0` and `e1000=0`!
