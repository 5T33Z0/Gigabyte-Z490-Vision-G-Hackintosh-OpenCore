...
4. Graphics: 
 ...
 - If you want to use the Intel UHD 630 iGPU to drive a Display, you have to copy the Framebuffer-Patch located under "Additional Files" to the `DeviceProperties > Add`
5. Create or Copy over SMBIOS for `iMac20,2` or `iMac18,3` (for High Sierra)
