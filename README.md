...
**IMPORTANT**: In macOS Big Sur 11.4, the Kernel Patch for the I225 Ethernet Controller doesn't work currently. Revert back to the FackePCIID kext included in my latest EFI release.
